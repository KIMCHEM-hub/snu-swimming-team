...
const DICT = {
  ko: {
    ...
    "members.sessionDetailsTitle": "세부 세트",
    "members.sessionDetailAdd": "+ 세트 추가",
    "members.sessionDetailDistance": "거리(m)",
    "members.sessionDetailSets": "세트 수",
    "members.sessionDetailPace": "페이스 (x:xx)",
    "members.sessionDetailsInvalid": "세부 세트를 확인해 주세요 — 거리·세트 수는 1 이상, 페이스는 x:xx 형식이어야 합니다.",
    ...
    "training.sessionModal.setsTitle": "세부 세트",
    ...
    "training.sessionModal.setsLoading": "세부 세트를 불러오는 중입니다…",
    "training.sessionModal.setsEmpty": "등록된 세부 세트가 없습니다.",
  ...
  en: {
    ...
    "members.sessionDetailsTitle": "SET BREAKDOWN",
    "members.sessionDetailAdd": "+ ADD SET",
    "members.sessionDetailDistance": "DISTANCE (M)",
    "members.sessionDetailSets": "SETS",
    "members.sessionDetailPace": "PACE (X:XX)",
    "members.sessionDetailsInvalid": "Check the set breakdown — distance and sets must be 1 or more, and pace must be in x:xx format.",
    ...
    "training.sessionModal.setsTitle": "SET BREAKDOWN",
    ...
    "training.sessionModal.setsLoading": "Loading set breakdown…",
    "training.sessionModal.setsEmpty": "No set breakdown is registered.",
