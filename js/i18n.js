...
const DICT = {
  ko: {
    ...
    "members.selfReportIntro": "자유수영·4인모임 참여를 스스로 기록합니다. 관리자 승인 후 표시되며, 정식 출석률에는 반영되지 않습니다.",
  ...
  en: {
    ...
    "members.selfReportIntro": "Record your own free-swim or 4-person meetup participation. It appears after administrator approval and does not count toward the official attendance rate.",
